...
int main()
{
   printf(" Variant5 (doing computation left to right (cond0) and right to left (cond1)) of Method 2 :-  GPU elementwise implementation  method :- \n");
   ...
   double *Y;
    ...
    printf("total time taken by gpu elementwise program (variant5 - doing computation left to right (cond0) and right to left (cond1) ) is %lf milliseconds for input size of %d , numHiddenUnits of %d and timeSteps of %d \n", total_time, inputSize, numHiddenUnits, timeSteps );
